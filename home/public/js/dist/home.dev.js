...
$(document).ready(function () {
  var col = $('.partner .owl-carousel').data('col') ? $('.partner .owl-carousel').data('col') : 6;
...
$(document).ready(function () {
  ...
  sync1.owlCarousel({
    ...
    navText: ['<svg width="100%" height="100%" viewBox="0 0 11 20"><path style="fill:none;stroke-width: 1px;stroke: #000;" d="M9.554,1.001l-8.607,8.607l8.607,8.606"></path></svg>', '<svg width="100%" height="100%" viewBox="0 0 11 20"><path style="fill:none;stroke-width: 1px;stroke: #000;" d="M1.054,18.214l8.606,-8.606l-8.606,-8.607"></path></svg>']
  });
  sync2.owlCarousel({
